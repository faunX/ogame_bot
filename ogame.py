...
class OGame:
    ...
    def get_ship_name(self, ship):
        ...
        names = [
            204: 'Лёгкий истребитель', 205: 'Тяжёлый истребитель',
            206: 'Крейсер', 207: 'Линкор', 215: 'Линейный крейсер',
            211: 'Бомбардировщик', 213: 'Уничтожитель', 214: 'Звезда смерти',
            218: 'Жнец', 219: 'Первопроходец', 202: 'Малый транспорт',
            203: 'Большой транспорт', 208: 'Колонизатор', 209: 'Переработчик',
            210: 'Шпионский зонд',
        ]
